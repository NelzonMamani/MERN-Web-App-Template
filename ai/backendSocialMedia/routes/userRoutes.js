...
router.delete('/logoutAll', authenticate, authorize('admin'), logoutAll);


// router.post('/logout', authenticate, validateAccessToken, userController.logout);
// router.post('/logoutAll', authenticate, validateAccessToken, userController.logoutAll);
